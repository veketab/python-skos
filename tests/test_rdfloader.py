...
class TestUnicode(TestCase):
    ...
    def testLanguages(self):
        ...
        assert (
            concept.definition == "Prueba de caracteres unicode ó"
        ), concept.definition
...
class TestRDFLoader(TestCase):
    ...
    def testGetConceptSchemes(self):
        ...
        for scheme in schemes.values():
            ...
            self.assertEqual(
                scheme.description,
                "An example thesaurus to illustrate the use of the SKOS-Core schema.",
            )
    ...
    def testGetCollections(self):
        ...
        for collection in collections.values():
            ...
            self.assertEqual(
                collection.description, "A collection of concepts used as a test"
            )
...
class TestRDFParsing(TestRDFLoader):
    ...
    def testRelated(self):
        ...
        keys = [
            self.getExternalResource("external2-dce.xml"),
            "http://portal.oceannet.org/test3",
        ]
        for key in keys:
